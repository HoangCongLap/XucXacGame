...
//
//    public BoardGameControlleetest() {
//    }
//
...
////  ===========================================
//                System.out.println(CurrentPutMoney.putMoney);
//                System.out.println("danh sach danh:" + PutMoneyInBoard.listPutMoney.getMoneyPuts());
//                //===========================================
...
////        labTopLeft.setText(PutMoneyInBoardList.toString());
////        timer = new Timer();
////        timer.schedule(new TimerTask() {
////            @Override
////            public void run() {
